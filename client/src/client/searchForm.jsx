...
import SearchFilter from "./filterForm"
...
export default function SearchForm(){
    ...
    const {generalInfo, handleSubmit, handleChange} = useContext(DataContext)

    return(
        <div>
            <form onSubmit={handleSubmit} class="flex items-center p-5">            
