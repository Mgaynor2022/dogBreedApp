...
export default function HomePage(){
    ...
    return(
     ...
     <div id='homePage' className="font-sans font-thin p-12 bg-gray-200">
			<div className="w-full h-screen relative flex items-center">
				<img src="https://images.unsplash.com/photo-1583336663277-620dc1996580?w=1800"
				 className="absolute top-0 left-0 w-full h-full object-cover" />

			<div className="relative z-10 px-24 text-center">
				<h2 className="mb-2 text-white text-2xl md:text-5xl leading-tight tracking-wide font-normal">Mans Best Friend</h2>
				<p className="text-white mb-6">Come find an adorable pet to give a home and to love.</p>
				<Link to="#searchBreed" smooth className="uppercase bg-white py-3 px-6 text-xs">Get Started</Link>
			</div>		
		</div>
		<div className="bg-gray-100 py-24 px-12 text-center">
			<h2 className="text-lg md:text-2xl mb-8">“Animals are reliable, many full of love, true in their affections, predictable in their actions, grateful and loyal.
             ...
             <br></br>
             <br className=" hidden lg:block" /> – Alfred A. Montapert</h2>
		</div>
    </div>
